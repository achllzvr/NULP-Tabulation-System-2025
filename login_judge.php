  ...
  <div class="mx-auto max-w-sm w-full p-8 space-y-6 bg-white bg-opacity-15 backdrop-blur-md rounded-2xl shadow-2xl border border-white border-opacity-20">
    ...
    <form id="judgeLoginForm" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input name="username" type="text" required class="w-full bg-white bg-opacity-20 backdrop-blur-sm border border-white border-opacity-30 rounded-lg px-4 py-3 text-sm text-white placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-opacity-50 focus:border-opacity-50 transition-all" placeholder="Enter your username" />
        </div>
        <div>
            <label class="block text-sm font-medium text-slate-200 mb-2">Password</label>
            <input name="password" type="password" required class="w-full bg-white bg-opacity-20 backdrop-blur-sm border border-white border-opacity-30 rounded-lg px-4 py-3 text-sm text-white placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-opacity-50 focus:border-opacity-50 transition-all" placeholder="Enter your password" />
        </div>
        <button name="login" type="submit" class="w-full bg-orange-500 bg-opacity-30 backdrop-blur-sm hover:bg-opacity-40 text-white font-medium px-4 py-3 rounded-lg border border-orange-400 border-opacity-50 hover:border-opacity-70 transition-all duration-300 transform hover:scale-105">Login</button>
    </form>
