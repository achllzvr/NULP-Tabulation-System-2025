...
?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-8">
      <div class="flex items-center justify-between mb-6">
        ...
        <div class="text-right">
          ...
          <p class="text-lg font-semibold text-slate-800"><?php echo $completedSteps; ?>/<?php echo $totalSetupSteps; ?> steps</p>
        </div>
      </div>
      
      <!-- Progress Bar -->
      <div class="w-full bg-slate-200 rounded-full h-2 mb-8">
        <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo round($progressPercentage); ?>%"></div>
      </div>

      <!-- Progress Steps Grid -->
      <div class="grid md:grid-cols-2 gap-6">
        <!-- Participants Step -->
        <div class="flex items-center justify-between p-4 <?php echo $setupSteps['participants'] ? 'bg-green-50 border-green-200' : 'bg-slate-50 border-slate-200'; ?> border rounded-lg">
          <div class="flex items-center gap-3">
            <div class="w-8 h-8 <?php echo $setupSteps['participants'] ? 'bg-green-500' : 'bg-slate-300'; ?> rounded-full flex items-center justify-center">
            ...
            <div>
              ...
              <p class="text-sm <?php echo $setupSteps['participants'] ? 'text-green-600' : 'text-slate-600'; ?>">
                <?php echo $participantsCount; ?> <?php echo $participantsCount == 1 ? 'participant' : 'participants'; ?>
              </p>
            </div>
          </div>
          <a href="participants.php" class="text-sm text-blue-600 hover:text-blue-700 font-medium">
            <?php echo $setupSteps['participants'] ? 'View' : 'Add'; ?>
          </a>
        </div>

        <!-- Judges Step -->
        <div class="flex items-center justify-between p-4 <?php echo $setupSteps['judges'] ? 'bg-green-50 border-green-200' : 'bg-slate-50 border-slate-200'; ?> border rounded-lg">
          <div class="flex items-center gap-3">
            <div class="w-8 h-8 <?php echo $setupSteps['judges'] ? 'bg-green-500' : 'bg-slate-300'; ?> rounded-full flex items-center justify-center">
            ...
            <div>
              ...
              <p class="text-sm <?php echo $setupSteps['judges'] ? 'text-green-600' : 'text-slate-600'; ?>">
                <?php echo $judgesCount; ?> <?php echo $judgesCount == 1 ? 'judge' : 'judges'; ?>
              </p>
            </div>
          </div>
          <a href="judges.php" class="text-sm text-blue-600 hover:text-blue-700 font-medium">
        ...
        ?>
        <div class="flex items-center justify-between p-4 <?php echo $setupSteps['preliminary'] ? 'bg-green-50 border-green-200' : 'bg-slate-50 border-slate-200'; ?> border rounded-lg">
          <div class="flex items-center gap-3">
            <div class="w-8 h-8 <?php echo $setupSteps['preliminary'] ? 'bg-green-500' : 'bg-slate-300'; ?> rounded-full flex items-center justify-center">
            ...
            <div>
              ...
              <p class="text-sm <?php echo $setupSteps['preliminary'] ? 'text-green-600 font-medium' : 'text-slate-600'; ?>">
                <?php echo $prelimRound ? $prelimRound['state'] : 'NOT CREATED'; ?>
              </p>
            </div>
          </div>
          <a href="rounds.php" class="text-sm text-blue-600 hover:text-blue-700 font-medium">
        ...
        ?>
        <div class="flex items-center justify-between p-4 <?php echo $setupSteps['final'] ? 'bg-green-50 border-green-200' : 'bg-slate-50 border-slate-200'; ?> border rounded-lg">
          <div class="flex items-center gap-3">
            <div class="w-8 h-8 <?php echo $setupSteps['final'] ? 'bg-green-500' : 'bg-slate-300'; ?> rounded-full flex items-center justify-center">
            ...
            <div>
              ...
              <p class="text-sm <?php echo $setupSteps['final'] ? 'text-green-600 font-medium' : 'text-slate-600'; ?>">
    ...
    <div class="grid md:grid-cols-4 gap-6 mb-8">
      <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <p class="text-3xl font-bold text-slate-800 mb-1"><?php echo $participantsCount; ?></p>
        <p class="text-sm text-slate-600"><?php echo $participantsCount > 0 ? '1 division' : 'No participants'; ?></p>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <p class="text-3xl font-bold text-slate-800 mb-1"><?php echo $judgesCount; ?></p>
        <p class="text-sm text-slate-600"><?php echo $judgesCount > 0 ? 'Ready to score' : 'No judges assigned'; ?></p>
      </div>
        ...
        <div class="space-y-4">
          <?php if (empty($rounds)): ?>
            <div class="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
              <div>
                <h4 class="font-medium text-slate-800">No Rounds Created</h4>
                <p class="text-sm text-slate-600">Set up rounds to begin judging</p>
              </div>
              <span class="px-3 py-1 bg-slate-100 text-slate-600 rounded-full text-sm font-medium">SETUP NEEDED</span>
            </div>
          <?php else: ?>
        ...
        <div class="space-y-4">
          <?php if (empty($recentActivity)): ?>
            <div class="text-center py-4">
              ...
              <p class="text-xs text-slate-500 mt-1">Scoring activity will appear here</p>
            </div>
          <?php else: ?>
          ...
          <?php if ($setupSteps['participants']): ?>
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-slate-600">Setup completed</p>
              </div>
            </div>
          <?php endif; ?>
          ...
          <?php if ($setupSteps['judges']): ?>
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-slate-600">Ready for judging</p>
              </div>
            </div>
          <?php endif; ?>
        </div>
