...
// Util removed; esc() provided globally by bootstrap
            ...
            <div class="flex items-center space-x-4">
                ...
                <?php if ($activeRound): ?>
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200">
                        <?= esc($activeRound['name'] ?? 'No Active Round') ?>
                    </span>
                <?php endif; ?>
            </div>
            <div class="flex items-center space-x-4">
                <span class="text-gray-600">Welcome, <?= esc($currentUser['full_name'] ?? 'Judge') ?></span>
